    ...
    $.AdminLTE.layout = {
        ...
        fix: function () {
            ...
            if ($("body").hasClass("fixed")) {
                $(" .right-side").css("min-height", b - $(".main-footer").outerHeight());
                $(".content-wrapper .content").css("height", b - $(".main-footer").outerHeight() - 80);
            } else {
                var d;
                b >= c ? ($(" .right-side").css("min-height", b - a), d = b - a) : ($(".content-wrapper, .right-side").css("min-height", c), d = c);
                var e = $($.AdminLTE.options.controlSidebarOptions.selector);
                "undefined" != typeof e && e.height() > d && $(" .right-side").css("min-height", e.height())
            }
        },
        fixSidebar: function () {
        ...
        _fixForContent: function (a) {
            $(".right-side").css("min-height", a.height())
        }
    }, $.AdminLTE.boxWidget = {
